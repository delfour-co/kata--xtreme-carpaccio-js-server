# Kata Xtreme Carpaccio JS Server

## Pour commencer

Cliquez sur le bouton ci-dessous pour démarrer un nouvel environnement de développement :

[![Open in Gitpod](https://gitpod.io/button/open-in-gitpod.svg)](https://gitpod.io/#https://github.com/delfour-co/kata--xtreme-carpaccio-js-server.git)
...
- Pour installer les dépendances, utilisez la commande : `npm install`
- Pour lancer le serveur, utilisez la commande : `npm start`
- Pour lancer le serveur en mode debug, utilisez la commande : `DEBUG=xcarpaccio:server npm start`
